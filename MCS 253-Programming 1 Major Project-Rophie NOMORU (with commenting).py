#Create a class call VARK.
#(The class named VARK is defined by the code to encapsulate the VARK questionnaire logic.)
class VARK:

    #Define a unique function call Init function.
    #(This is a init (short form of initialization).
    #(The VARK class is initialized with dictionaries for questions, answers, an answer guide, user answers and scores.)
    def __init__(self):

            #Dictionary of Questions.
            #(This dictionary stores the 16 questions, each with a unique number.)
        self.questions = {
        ...
        #(This dictionary stores the four (4) optional answers for each questions respectively.)
        #(The answers are arranged in keys and values. Keys are represented by letters A, B, C and D while, values are represented by sentences.)  )
        self.answers = {
            ...
            8: {"A": "gave you a web address or something to read about it.", "B": "used a plastic model of a knee to show what was wrong.", "C": "described what was wrong.", "D": "howed you a diagram of what was wrong."},
        ...
        #Dictionary of Answer Guid.
        #(This dictionary stores the answer guid for each of the 16 question, in which each optional answers (A, B, C and D) are matched with each of the learning preferences (VARK) respectively.
        self.answer_guide = {
            1:{"A":"K","B":"A","C":"R","D":"V"},
            2:{"A":"V","B":"A","C":"R","D":"K"},
            3:{"A":"K","B":"V","C":"R","D":"A"},
    ...
    # Define a unique function call run_test.
    # (This function prints out the introduction and the question with answers, and taking in users input.) 
    def run_test(self):
        
        #This is the introduction and the instruction information to the users.
        ...
        #This is an empty dictionary to store the user's answers.
        user_answers = {}

        #This method prints out a question and its answer options.
        for question_num, question in self.questions.items():
            ...
            #This method iterates through quuestions, prompts for answers(one or two) and validates input.
            while True:
    ...
    #This unique function iterate through user answers. 
    def calculate_score(self, user_answers):
        
        #This is the dictionary of scores.
        scores = {"V": 0, "A": 0, "R": 0, "K": 0}
        for question_num, answers in user_answers.items():
            for answer in answers:
                scores[self.answer_guide[question_num][answer]] += 1
        
        #This is two rows of dashed parallel lines at the end of the 16th question.
        print("-"*100)
        print("-"*100)
        
        #This is output of the users VARK score.
        print("\nYour VARK scores:")
    ...
    def interpret_results(self, scores):
       ...
       #This prints the preference for one dominant learning preference. 
        ...
        #This prints the preferences of multiple (two) dominant learning preference.
        else:
        ...
        #This is some further interpretation based on VARK learning styles/preferences and also the closing remarks of the program.
...
#This is the end of the program, thus it return back to the function and class  that was called.        
